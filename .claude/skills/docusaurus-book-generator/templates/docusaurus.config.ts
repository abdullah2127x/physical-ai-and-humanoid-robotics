...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/{{GITHUB_ORG}}/{{GITHUB_REPO}}/edit/main/website/docs/',
        },
        blog: {
          ...
          // Remove this to remove the "edit this page" links.
          editUrl:
            'https://github.com/{{GITHUB_ORG}}/{{GITHUB_REPO}}/edit/main/website/blog/',
        },
        theme: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © \${new Date().getFullYear()} {{BOOK_TITLE}} Built with Docusaurus.`,
    },
    prism: {
